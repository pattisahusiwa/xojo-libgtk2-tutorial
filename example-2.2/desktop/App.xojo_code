...
Inherits Application
	#tag Event
		Sub Open()
		  ...
		  gtk_window_set_title(window, "Submenu")
		  ...
		  dim imprMenu as Ptr = gtk_menu_new()
		  dim imprMi as Ptr = gtk_menu_item_new_with_label("Import")
		  dim feedMi as Ptr = gtk_menu_item_new_with_label("Import news feed...")
		  dim bookMi as Ptr = gtk_menu_item_new_with_label("Import bookmarks...")
		  dim mailMi as Ptr = gtk_menu_item_new_with_label("Import bookmarks...")
		  
		  gtk_menu_item_set_submenu(imprMi, imprMenu)
		  gtk_menu_shell_append(imprMenu, feedMi)
		  gtk_menu_shell_append(imprMenu, bookMi)
		  gtk_menu_shell_append(imprMenu, mailMi)
		  ...
		  gtk_menu_shell_append(fileMenu, imprMi)
